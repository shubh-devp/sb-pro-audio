...
//   },
//   { 
//     // Hammer/Rugged build icon
//     icon: (
//       <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
//         <path d="m15 12-8.373 8.373a1 1 0 1 1-1.414-1.414L13.586 10.586"/><path d="m18 4.75 3.25 3.25c.3.3.3.75 0 1.05L14.5 15.8c-.3.3-.75.3-1.05 0L10.2 12.55c-.3-.3-.3-.75 0-1.05L16.95 4.75c.3-.3.75-.3 1.05 0z"/>
//       </svg>
//     ), 
...
//         {/* Left: Interactive Image Group (Reveals Left to Right) */}
...
//               alt="Pro Audio Equipment Pune"
//             />
//           </div>
//           <div className="about__img-badge">
//             <span className="about__img-badge-num">15<sup>+</sup></span>
//             <span className="about__img-badge-text">Years of<br />Excellence</span>
//           </div>
//         </div>

//         {/* Right: Content Section (Staggered Upward Reveals) */}
//         <div className="about__content">
//           <div className="about__eyebrow scroll-reveal-up" style={{ transitionDelay: "0.1s" }}>
//             About SB PRO-AUDIO
//           </div>

//           <h2 className="about__title scroll-reveal-up" style={{ transitionDelay: "0.2s" }}>
//             Quality <span className="about__title-sep">|</span> Commitment{" "}
//             <span className="about__title-sep">|</span>{" "}
//             <span className="about__title-accent">Innovation</span>
//           </h2>

//           <p className="about__desc scroll-reveal-up" style={{ transitionDelay: "0.3s" }}>
//             SB PRO-AUDIO is committed to delivering premium-grade professional audio systems
//             with innovation, durability, and unmatched sound clarity. Inspired by modern
//             pro-audio industry standards, we manufacture high-quality sound equipment designed
//             for professional use across India.
//           </p>
//           <p className="about__desc scroll-reveal-up" style={{ transitionDelay: "0.4s" }}>
//             At SB PRO-AUDIO, we believe where performance meets perfection. Our sound systems
//             are engineered to deliver unmatched power, versatility, and extraordinary sound clarity.
//           </p>
...
//           <div className="about__footer scroll-reveal-up" style={{ transitionDelay: "0.9s" }}>
